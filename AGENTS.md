...
- The **main session runs on Sonnet, and it orchestrates only** — it does not implement, edit
  ...
  time.
- Each phase (see `docs/SPEC.md` §10 phasing table, P0–P13) gets an Opus-authored plan committed
...
- This holds for as long as phases in `docs/SPEC.md` §10 remain unfinished. Once P13 (Ship) is

Phase plans for `docs/SPEC.md` §10, one per phase (P0–P12), plus the occasional scope-reduction
...
`P13-flatbuffers-migration.md` is queued as the final phase, after P12 (Ship): migrating
